...
class VentingMobLocalizationsEn extends VentingMobLocalizations {
  ...
  String email_registration_role_mismatch(String role) {
    return 'This email belongs to a $role account. Go back and choose the matching role, or use a different email.';
  }

  @override
  String get email_registration_checking_email => 'Checking email…';
