...
mixin _$CatalogCategoryModel {
 ...
 String get id; String get name_en; String get name_ar; String get icon_emoji; String get icon_url; int get sort_order; bool get allows_custom_text; String? get topic_group;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name_en,name_ar,icon_emoji,icon_url,sort_order,allows_custom_text,topic_group);

@override
String toString() {
  return 'CatalogCategoryModel(id: $id, name_en: $name_en, name_ar: $name_ar, icon_emoji: $icon_emoji, icon_url: $icon_url, sort_order: $sort_order, allows_custom_text: $allows_custom_text, topic_group: $topic_group)';
}
...
@useResult
$Res call({
 String id, String name_en, String name_ar, String icon_emoji, String icon_url, int sort_order, bool allows_custom_text, String? topic_group
});
...
/// Create a copy of CatalogCategoryModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name_en = null,Object? name_ar = null,Object? icon_emoji = null,Object? icon_url = null,Object? sort_order = null,Object? allows_custom_text = null,Object? topic_group = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name_en,  String name_ar,  String icon_emoji,  String icon_url,  int sort_order,  bool allows_custom_text,  String? topic_group)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CatalogCategoryModel() when $default != null:
return $default(_that.id,_that.name_en,_that.name_ar,_that.icon_emoji,_that.icon_url,_that.sort_order,_that.allows_custom_text,_that.topic_group);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name_en,  String name_ar,  String icon_emoji,  String icon_url,  int sort_order,  bool allows_custom_text,  String? topic_group)  $default,) {final _that = this;
switch (_that) {
case _CatalogCategoryModel():
return $default(_that.id,_that.name_en,_that.name_ar,_that.icon_emoji,_that.icon_url,_that.sort_order,_that.allows_custom_text,_that.topic_group);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name_en,  String name_ar,  String icon_emoji,  String icon_url,  int sort_order,  bool allows_custom_text,  String? topic_group)?  $default,) {final _that = this;
switch (_that) {
case _CatalogCategoryModel() when $default != null:
return $default(_that.id,_that.name_en,_that.name_ar,_that.icon_emoji,_that.icon_url,_that.sort_order,_that.allows_custom_text,_that.topic_group);case _:
  return null;
...
class _CatalogCategoryModel implements CatalogCategoryModel {
  const _CatalogCategoryModel({required this.id, required this.name_en, required this.name_ar, this.icon_emoji = '', this.icon_url = '', this.sort_order = 0, this.allows_custom_text = false, this.topic_group});
...
/// Create a copy of CatalogCategoryModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name_en = null,Object? name_ar = null,Object? icon_emoji = null,Object? icon_url = null,Object? sort_order = null,Object? allows_custom_text = null,Object? topic_group = freezed,}) {
