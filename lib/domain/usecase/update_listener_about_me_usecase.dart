...
class UpdateListenerAboutMeUsecase {
  ...
  TaskEither<Exception, ListenerProfile> call({required String aboutMe}) {
    ...
    return listenerProfileRepository
        .updateAboutMe(aboutMe: aboutMe.trim())
        .map(
