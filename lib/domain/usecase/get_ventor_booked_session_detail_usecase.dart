...
class GetVentorBookedSessionDetailUsecase {
  ...
  TaskEither<Exception, VentorBookedSessionDetailData> call({
    ...
    return ventorSessionsRepository
        .getSession(sessionId: trimmedId)
        .map(
          (response) => ventorBookedSessionDetailFromApi(
            response.data,
