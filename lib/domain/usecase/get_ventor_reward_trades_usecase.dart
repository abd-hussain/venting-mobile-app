...
class GetVentorRewardTradesUsecase {
  ...
  TaskEither<Exception, List<VentorRewardTradeData>> call() {
    ...
    return ventorRewardsRepository.getTrades().map(
      (response) => ventorRewardTradesFromApi(response.data),
    );
  }
}
