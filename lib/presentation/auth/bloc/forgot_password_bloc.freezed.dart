...
mixin _$ForgotPasswordState {
 ...
 String get email; bool get isSubmitting; bool get emailSent; String get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,email,isSubmitting,emailSent,errorMessage);

@override
String toString() {
  return 'ForgotPasswordState(email: $email, isSubmitting: $isSubmitting, emailSent: $emailSent, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 String email, bool isSubmitting, bool emailSent, String errorMessage
});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? isSubmitting = null,Object? emailSent = null,Object? errorMessage = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  bool isSubmitting,  bool emailSent,  String errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.isSubmitting,_that.emailSent,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  bool isSubmitting,  bool emailSent,  String errorMessage)  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState():
return $default(_that.email,_that.isSubmitting,_that.emailSent,_that.errorMessage);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  bool isSubmitting,  bool emailSent,  String errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.email,_that.isSubmitting,_that.emailSent,_that.errorMessage);case _:
  return null;
...
class _ForgotPasswordState implements ForgotPasswordState {
  const _ForgotPasswordState({this.email = '', this.isSubmitting = false, this.emailSent = false, this.errorMessage = ''});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? isSubmitting = null,Object? emailSent = null,Object? errorMessage = null,}) {
