...
class _ListenerCallInstructionScreenState
  ...
  bool get _canJoin => _micGranted && _cameraGranted && !_joining;

  Future<void> _onJoinCall() async {
    if (!_canJoin) return;
    setState(() => _joining = true);

    // TODO: Notify backend that listener joined the session.
    if (!mounted) return;
    await Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (_) => ListenerCallScreen(args: widget.args)),
    );
  }
        ...
        body: ListView(
          ...
          children: [
            ...
            _InstructionTile(
              ...
              text: l10n.listener_call_instruction_time(args.durationMinutes),
            ),
            _InstructionTile(
