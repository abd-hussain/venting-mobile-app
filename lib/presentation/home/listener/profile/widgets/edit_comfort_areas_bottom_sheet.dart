...
/// Catalog of comfort areas (same as registration step 5).
abstract final class ListenerComfortAreaOptions {
  static List<ComfortAreaOption> areas(VentingMobLocalizations l10n) => [
    ComfortAreaOption(
      id: 'relationships',
  ...
  static List<String> displayLabels({
    ...
    required EditComfortAreasResult selection,
  }) {
    return [
...
Future<EditComfortAreasResult?> showEditComfortAreasBottomSheet({
  required BuildContext context,
  EditComfortAreasResult? initial,
}) {
  return showModalBottomSheet<EditComfortAreasResult>(
    context: context,
    ...
    builder: (context) => EditComfortAreasBottomSheet(initial: initial),
  );
}

class EditComfortAreasBottomSheet extends StatefulWidget {
  const EditComfortAreasBottomSheet({super.key, this.initial});

  final EditComfortAreasResult? initial;

  @override
  State<EditComfortAreasBottomSheet> createState() =>
      _EditComfortAreasBottomSheetState();
}

class _EditComfortAreasBottomSheetState
  ...
  Widget build(BuildContext context) {
    ...
    final areas = ListenerComfortAreaOptions.areas(l10n);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                l10n.listener_profile_edit_comfort_areas_title,
              ...
              Text(
                l10n.listener_profile_edit_comfort_areas_subtitle,
                textAlign: TextAlign.center,
                style: GoogleFonts.inter(
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(icon, size: 22, color: SplashColors.purpleMid),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
