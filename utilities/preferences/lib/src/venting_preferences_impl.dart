...
class VentingPreferencesImpl implements VentingPreferences {
  final SharedPreferences _preferences;

  const VentingPreferencesImpl(this._preferences);

  static Future<VentingPreferencesImpl> create() async {
    final prefs = await SharedPreferences.getInstance();
    return VentingPreferencesImpl(prefs);
  }
